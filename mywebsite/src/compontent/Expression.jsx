...
import './expresion.css';

function Expression() {
  return (
    <>
    <h3> Expre<span>sion</span></h3>
    
    <div className='expreesion' id='exp'>
  ...
  <div className="item item--4">
    ...
    <span className="text text--4"> mongoDb </span>
  </div>
</div>
